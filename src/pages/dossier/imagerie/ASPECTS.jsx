...
const AspectsSection = ({
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (data) {
                setCheckZone({
                    ProfondD: data.AspectsDetails.includes("ProfondD"),
                    ProfondG: data.AspectsDetails.includes("ProfondG"),
                    SuperficielAntérieurG: data.AspectsDetails.includes(
                        "SuperficielAntérieurG"
                    ),
                    SuperficielAntérieurD: data.AspectsDetails.includes(
                        "SuperficielAntérieurD"
                    ),
                    SuperficielPostérieurG: data.AspectsDetails.includes(
                        "SuperficielPostérieurG"
                    ),
                    SuperficielPostérieurD: data.AspectsDetails.includes(
                        "SuperficielPostérieurD"
                    ),
                });
            }
        };
