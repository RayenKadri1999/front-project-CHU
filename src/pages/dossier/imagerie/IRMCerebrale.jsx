...
const IRM = ({
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (data) {
                setCheckZone({
                    CerebralmoyenD: data.Details.includes(
                        "Cérébral moyen Droite"
                    ),
                    CerebralmoyenG: data.Details.includes(
                        "Cérébral moyen Gauche"
                    ),

                    CerebralanterieurG: data.Details.includes(
                        "Cérébral antérieur Gauche"
                    ),
                    CerebralanterieurD: data.Details.includes(
                        "Cérébral antérieur Droite"
                    ),

                    CerebralposterieurG: data.Details.includes(
                        "Cérébral postérieur Gauche"
                    ),
                    CerebralposterieurD: data.Details.includes(
                        "Cérébral postérieur Droite"
                    ),

                    PontiqueparamedianG: data.Details.includes(
                        "Pontique paramédian Gauche"
                    ),
                    PontiqueparamedianD: data.Details.includes(
                        "Pontique paramédian Droite"
                    ),

                    LaterobulbaireG: data.Details.includes(
                        "Latéro bulbaire Gauche"
                    ),
                    LaterobulbaireD: data.Details.includes(
                        "Latéro bulbaire Droite"
                    ),

                    Latero_pontiqueG: data.Details.includes(
                        "Latéro pontique Gauche"
                    ),
                    Latero_pontiqueD: data.Details.includes(
                        "Latéro pontique Droite"
                    ),
    ...
    const handleSubmit = (e) => {
        ...
        if (IRMData.status === "Non") {
            ...
            apiServices.handleDeleteIRMDetails(
                e,
                "sequenceperfusion",
                setError,
                id
                ...
                >
                    <Stack direction="row" spacing={4} alignItems="center">
                        ...
                        <RadioGroup
                            ...
                            name="status"
                            defaultValue="Normal"
                            value={IRMData.status}
                            onChange={(event) =>
                                handleChange2(event, setIRMData)
                            }
                        >
                            <FormControlLabel
                                value="Oui"
                                        ...
                                        {IRMData.IRM_Cerebrale ===
                                            ...
                                            <>
                                                ...
                                                <Box sx={{ mt: 2 }}>
                                                    {[
                                                        {
                                                            label: "Cérébral moyen",
                                                            name: "Cérébral moyen",
                                                            id: "Cerebralmoyen",
                                                        },
                                                        {
                                                            label: "Cérébral antérieur",
                                                            name: "Cérébral antérieur",
                                                            id: "Cerebralanterieur",
                                                        },
                                                        {
                                                            label: "Cérébral postérieur",
                                                            name: "Cérébral postérieur",
                                                            id: "Cerebralposterieur",
                                                        },
                                                        {
                                                            label: "Pontique paramédian",
                                                            name: "Pontique paramédian",
                                                            id: "Pontiqueparamedian",
                                                        },
                                                        {
                                                            label: "Latéro-bulbaire",
                                                            name: "Latéro bulbaire",
                                                            id: "Laterobulbaire",
                                                        },
                                                        {
                                                            label: "Latéro  pontique",
                                                            name: "Latéro_pontique",
                                                            id: "Latero_pontique",
                                                        },
                                                        {
                                                            label: "Cérébelleux (PICA)",
                                                            name: "PICA",
                                                            id: "PICA",
                                                        },
                                                        {
                                                            label: "Cérébelleux (AICA)",
                                                            name: "AICA",
                                                            id: "AICA",
                                                        },
                                                        {
                                                            label: "Cérébelleux (ACS)",
                                                            name: "ACS",
                                                            id: "ACS",
                                                        },
                                                        {
