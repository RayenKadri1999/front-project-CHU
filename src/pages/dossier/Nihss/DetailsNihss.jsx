...
import { ModalNihss } from "../addnihssmodal";
import { DataGrid } from "@mui/x-data-grid";
import authHeader from "../../../services/auth-header";
import PdfButton from "../../../components/shared/PdfButton";
import apiServices from "../../../services/api-services";
import Nihss from "./Nihss";
function DetailsNihss({handleClose,idNihss,loadDossierDetails,setSuccessMessage}) {
...
//tous les champs //0..4
  ...
  const handleSubmit = (e) => {
    ...
    apiServices.handleSubmitModal(e,NihssData,"nihss",setSuccessMessage,false,handleClose,setError,idNihss);
   }
