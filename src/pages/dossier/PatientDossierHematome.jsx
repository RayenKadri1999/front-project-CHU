        ...
        <>
            ...
            <Box sx={{ display: "flex" }}>
                ...
                >
                    ...
                    {activeComponent === 'Imagerie' && <ImagerieHematome commonState={commonState} />}
                    {activeComponent === 'Download' && <Download commonState={commonState} />}
                    {activeComponent === 'Biologie' && <BiologieHematome commonState={commonState} />}
                    {activeComponent === 'Conclusion Sortie' && <ConclusionSortieHematome commonState={commonState} />}
                    {activeComponent === 'Nihss' && <Nihss commonState={commonState} />}
                    {activeComponent === 'ExamenClinique' && <ExamenClinique_Hematome commonState={commonState} />}
                    {activeComponent === 'ExamensComplementaires' && <ExamensComplementaires_Hematome commonState={commonState} />}
                    {activeComponent === 'EvolutionClassification' && <Evolution_Classification_Hematome commonState={commonState} />}
                    {activeComponent === 'Etiologie' && <Etiologie_Hematome commonState={commonState} />}
                    {activeComponent === 'ConclusionInitiale' && <ConclusionInitiale_Hematome commonState={commonState} />}
                    {activeComponent === 'Conduiteàtenirinitiale' && <ConduiteTenirInitiale_Hematome commonState={commonState} />}
