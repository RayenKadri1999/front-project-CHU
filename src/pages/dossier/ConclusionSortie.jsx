            ...
            <Box sx={{ display: "flex" }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        >
                            ...
                            <Select
                                ...
                                disabled={!isEditable}
                            >
                                <MenuItem value="A domicile">
                                    A domicile
                                </MenuItem>
                                <MenuItem value="Transfert dans un autre service">
                        ...
                        >
                            ...
                            {conclusionSortieData.TraitementSortie.map(
                                (value, index) => (
                                    <div
                                        key={index}
                                        style={{
              ...
              >
                ...
                <MenuItem value="examensComplementaires">Examens Complémentaires</MenuItem>
                            ...
                            {conclusionSortieData.RecommandationsSortie.map(
                                (value, index) => (
                                    <div
                                        key={index}
                                        style={{
                            ...
                            <Button
                                ...
                                color="primary"
                                onClick={() =>
                                    addTextField("RecommandationsSortie")
                                }
                                disabled={!isEditable}
                            >
                                +
